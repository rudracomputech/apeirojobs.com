   ...
   <div class="min-h-screen flex flex-col items-center justify-center">
      <div class="max-w-md w-full">
         ...
         <div
            ...
            <form class="space-y-6 mt-10" action="<?php echo e(route('login-handle')); ?>" method="POST">
               <?php echo csrf_field(); ?>
               <div>
                  <label for="email"
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/willpowe/domains/apeirojobs.com/resources/views/auth/login.blade.php ENDPATH**/ ?>