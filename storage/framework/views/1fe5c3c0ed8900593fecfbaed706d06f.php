<?php $__env->startSection('title', 'Generated Student ID Cards'); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-7 text-indigo-600']); ?>
...
<?php endif; ?>
        ...
        <div class="flex flex-wrap items-center gap-4 mb-6">
            <form class="max-w-md w-full sm:w-80" role="search" method="GET" action="<?php echo e(route('idcard.records')); ?>">
...
<?php endif; ?>
            ...
            <div class="flex items-center gap-3 ml-auto">
                <form method="GET" action="<?php echo e(route('idcard.records')); ?>" id="limitForm">
                ...
                <thead class="text-xs uppercase font-semibold text-slate-700 dark:text-slate-300 bg-slate-50 dark:bg-neutral-800 border-b border-slate-200 dark:border-neutral-700">
                    <tr>
                        <th scope="col" class="px-4 py-3.5 w-16">
                            <a href="<?php echo e(route('idcard.records', array_merge($queryParams, ['sort' => 'id', 'direction' => $nextDirection('id')]))); ?>" class="flex items-center gap-1">
                                ID
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-3 text-indigo-600']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50/70 dark:hover:bg-neutral-800/40 transition-colors">
                            ...
                            <td class="px-4 py-3.5">
                                <div class="flex items-center gap-3">
                                    <img src="<?php echo e($card->photo ?: asset('idcard-studio/assets/images/default_avatar.svg')); ?>"
                                    ...
                                    <div>
                                        ...
                                        <div class="text-xs text-slate-400 font-mono"><?php echo e($card->card_uid); ?></div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-4 py-3.5 text-slate-800 dark:text-slate-200">
                                <div class="font-medium text-xs sm:text-sm line-clamp-1" title="<?php echo e($card->course); ?>"><?php echo e($card->course ?: '-'); ?></div>
                                <div class="text-xs text-slate-500"><?php echo e($card->session ?: '-'); ?></div>
                            </td>
                            <td class="px-4 py-3.5 text-xs font-semibold text-red-600 dark:text-red-400">
                                <?php echo e($card->blood_group ?: '-'); ?>

                            </td>
                            <td class="px-4 py-3.5 text-xs text-slate-600 dark:text-slate-400">
                                <?php echo e($card->emergency_contact ?: '-'); ?>

                            </td>
                            <td class="px-4 py-3.5 text-xs text-slate-500 whitespace-nowrap">
                                <?php echo e($card->valid_upto ?: '-'); ?>

                            </td>
                            <td class="px-4 py-3.5 text-right whitespace-nowrap">
                                <div class="flex items-center justify-end gap-2">
                                    <!-- Print Standalone -->
                                    <a href="<?php echo e(route('idcard.print', ['id' => $card->id])); ?>" target="_blank"
...
<?php endif; ?>
                                    ...
                                    <!-- Edit in Studio -->
                                    <a href="<?php echo e(route('idcard.index', ['id' => $card->id])); ?>"
...
<?php endif; ?>
                                    ...
                                    <!-- Delete -->
                                    <form action="<?php echo e(route('idcard.destroy', $card->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this ID Card?');" class="inline">
                                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
                                ...
                                <a href="<?php echo e(route('idcard.index')); ?>" class="inline-flex items-center gap-1.5 mt-4 px-3.5 py-2 text-xs font-semibold rounded-md bg-indigo-600 text-white hover:bg-indigo-700">
                                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('lucide-plus'); ?>
...
<?php echo $__env->make('layouts.backend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/willpowe/domains/apeirojobs.com/resources/views/backend/idcard/records.blade.php ENDPATH**/ ?>