...
<header
   ...
   style="background-color: <?php echo e($settings['mainbar_background_color'] ?? '#f8fafc'); ?>; color: <?php echo e($settings['body_text_color'] ?? '#334155'); ?>;"
   aria-label="header">
   <div class="flex flex-wrap items-center gap-4 w-full">
      ...
      <h1 class="text-xl text-slate-900 font-bold dark:text-slate-50"><?php echo $__env->yieldContent('title'); ?></h1>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-[24px]  overflow-visible']); ?>
...
<?php endif; ?>
                  <span
                     class="bg-red-500 text-[10px] px-1 font-semibold min-w-[16px] h-4 flex items-center justify-center text-white rounded-full absolute -top-2 left-[60%]"><?php echo e($notificationUnreadCount ?? 0); ?></span>
               </button>
            </div>
            <!-- Dropdown Menu -->
               ...
               <div aria-labelledby="notification-title"
                  ...
                  <ul class="divide-y divide-slate-300 dark:divide-neutral-700">
                     <?php $__empty_1 = true; $__currentLoopData = $notificationItems ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                         <?php $payload = json_decode($notification->data, true); ?>
                         <li>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-[18px] text-slate-600 dark:text-slate-200']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                               ...
                               <div class="flex-1">
                                  <p class="text-sm leading-snug text-slate-900 dark:text-slate-50">
                                     <?php echo e($payload['message'] ?? ucfirst(str_replace('.', ' ', $notification->type))); ?>

                                  </p>
                                  <p class="text-xs text-slate-600 dark:text-slate-400 mt-1"><?php echo e($notification->created_at?->diffForHumans() ?? '-'); ?></p>
                               </div>
         ...
         <div class="relative w-max flex flex-col">
            <button type="button" id="dropdown-toggle" aria-haspopup="true" aria-expanded="false"
               ...
               <img src="<?php echo e(Auth::user()->getFirstMediaUrl('avatars')); ?>" alt="profile-pic" class="size-9 rounded-full" />
            </button>
...
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('lucide-circle-user'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
...
</header><?php /**PATH /home/willpowe/domains/apeirojobs.com/resources/views/layouts/backend/header.blade.php ENDPATH**/ ?>