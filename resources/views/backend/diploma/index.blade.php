...
<head>
  ...
  <title>Diploma Certificate Studio - {{ $data['studentName'] }}</title>
...
<body>
  ...
  <header class="app-header no-print">
    ...
    <div class="header-actions">
      <a href="{{ route('diploma.records') }}" class="btn btn-secondary-outline" style="background: #2563eb; color: #fff; text-decoration: none; border-radius: 6px; padding: 6px 12px; font-weight: 600; font-size: 13px; display: inline-flex; align-items: center; gap: 6px;">
        📋 All Diplomas
      </a>
    ...
    <aside class="sidebar no-print" id="sidebar">
      <div class="sidebar-header">
        <div class="sidebar-logo">
          <img id="sidebarLogoImg" src="{{ $data['instituteLogo'] }}" alt="AICVPS Logo" />
        </div>
        <h1 class="sidebar-title">Diploma Generator</h1>
        <p class="sidebar-sub" id="sidebarCouncilSub">{{ $data['councilName'] }}</p>
      </div>

      <form id="diplomaForm" method="POST" action="{{ route('diploma.print') }}" target="_blank" class="diploma-form" enctype="multipart/form-data">
        @csrf
        ...
        <input type="hidden" id="studentPhoto_data" name="studentPhoto_data" value="{{ $data['studentPhoto'] }}" />
        <input type="hidden" id="instituteLogo_data" name="instituteLogo_data" value="{{ $data['instituteLogo'] }}" />
        <input type="hidden" id="footerSeal_data" name="footerSeal_data" value="{{ $data['footerSeal'] }}" />
        <input type="hidden" id="scannerImage_data" name="scannerImage_data" value="{{ $data['scannerImage'] }}" />
        ...
        <section class="form-section">
          ...
          <div class="form-group">
            ...
            <input type="text" id="serialNo" name="serialNo" value="{{ $data['serialNo'] }}"
          ...
          <div class="form-row-2">
            <div class="form-group">
              ...
              <select id="gender" name="gender">
                <option value="Mr." {{ $data['gender'] === 'Mr.' ? 'selected' : '' }}>Mr.</option>
                <option value="Ms." {{ $data['gender'] === 'Ms.' ? 'selected' : '' }}>Ms.</option>
                <option value="Mrs." {{ $data['gender'] === 'Mrs.' ? 'selected' : '' }}>Mrs.</option>
                <option value="Dr." {{ $data['gender'] === 'Dr.' ? 'selected' : '' }}>Dr.</option>
              </select>
            </div>
            <div class="form-group flex-2">
              <label for="studentName">Student Name <span class="req">*</span></label>
              <input type="text" id="studentName" name="studentName"
                value="{{ $data['studentName'] }}" required placeholder="e.g. Laxman Patole" />
            </div>
          </div>

          <div class="form-group">
            <label for="fatherName">Son/Daughter of <span class="req">*</span></label>
            <input type="text" id="fatherName" name="fatherName" value="{{ $data['fatherName'] }}"
              required placeholder="e.g. Balasaheb Patole" />
          </div>

          <div class="form-group">
            <label for="enrollNo">Enrollment No. <span class="req">*</span></label>
            <input type="text" id="enrollNo" name="enrollNo" value="{{ $data['enrollNo'] }}" required
        ...
        <section class="form-section">
          ...
          <div class="form-group">
            ...
            <input type="text" id="courseCategory" name="courseCategory"
              value="{{ $data['courseCategory'] }}" placeholder="e.g. Paramedical Courses" />
          </div>

          <div class="form-group">
            <label for="courseName">Diploma / Degree Name <span class="req">*</span></label>
            <input type="text" id="courseName" name="courseName" value="{{ $data['courseName'] }}"
          ...
          <div class="form-group">
            ...
            <select id="division" name="division">
              <option value="1st Division" {{ $data['division'] === '1st Division' ? 'selected' : '' }}>1st Division</option>
              <option value="2nd Division" {{ $data['division'] === '2nd Division' ? 'selected' : '' }}>2nd Division</option>
              <option value="3rd Division" {{ $data['division'] === '3rd Division' ? 'selected' : '' }}>3rd Division</option>
              <option value="Distinction" {{ $data['division'] === 'Distinction' ? 'selected' : '' }}>Distinction</option>
              <option value="Pass" {{ $data['division'] === 'Pass' ? 'selected' : '' }}>Pass</option>
            </select>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" id="councilName" name="councilName" value="{{ $data['councilName'] }}"
        ...
        <section class="form-section">
          ...
          <div class="form-group">
            ...
            <input type="text" id="metaRunBy" name="metaRunBy" value="{{ $data['metaRunBy'] }}"
              placeholder="e.g. Run by All India Council for Vocational &amp; Paramedical Science" />
          </div>

          <div class="form-group">
            <label for="metaRegd">Registration Line</label>
            <input type="text" id="metaRegd" name="metaRegd" value="{{ $data['metaRegd'] }}"
          ...
          <div class="form-group">
            ...
            <input type="text" id="metaIso" name="metaIso" value="{{ $data['metaIso'] }}"
        ...
        <section class="form-section">
          ...
          <div class="form-row-2">
            <div class="form-group">
              ...
              <input type="date" id="certDate" name="certDate" value="{{ $data['certDate'] }}"
                required />
            </div>
            <div class="form-group">
        ...
        <section class="form-section">
          ...
          <div class="form-group">
            <div class="file-drop-zone" id="photoDropZone">
              ...
              <img id="photoThumbPreview" src="{{ $data['studentPhoto'] }}" alt="Preview" />
            </div>
          </div>
        </section>
        ...
        <section class="form-section">
          ...
          <div class="form-group">
            <div class="file-drop-zone" id="logoDropZone">
              ...
              <img id="logoThumbPreview" src="{{ $data['instituteLogo'] }}" alt="Preview" />
            </div>
          </div>
        </section>
        ...
        <section class="form-section">
          ...
          <div class="form-group">
            <div class="file-drop-zone" id="footerSealDropZone">
              ...
              <img id="footerSealThumbPreview" src="{{ $data['footerSeal'] }}" alt="Seal Preview" />
            </div>
          </div>
          <div class="form-group">
            <label for="footerSeal">Seal Image File / URL</label>
            <input type="text" id="footerSeal" name="footerSeal" value="{{ $data['footerSeal'] }}"
          ...
          <div class="form-group">
            <div class="file-drop-zone" id="scannerDropZone">
              ...
              <img id="scannerThumbPreview" class="scanner-preview-thumb"
                src="{{ $data['scannerImage'] }}" alt="Scanner Preview" />
            </div>
          </div>
          <div class="form-group">
            <label for="scannerImage">Scanner Image File / URL</label>
            <input type="text" id="scannerImage" name="scannerImage" value="{{ $data['scannerImage'] }}"
        ...
        ════════════════════════════════════════════════════════════ -->
          <div class="diploma-certificate" id="diplomaCertificate">
                ...
                <defs>
                  <pattern id="watermarkTextPattern" width="700" height="24" patternUnits="userSpaceOnUse">
                    <text id="d_watermarkPatternText" x="0" y="17" font-family="'Inter', 'Arial', sans-serif"
                      ...
                      letter-spacing="1.2">{{ $watermarkRepeat }}</text>
                  </pattern>
                </defs>
            ...
            <div class="center-crest-watermark" aria-hidden="true">
              <img src="{{ $data['instituteLogo'] }}" id="d_watermarkLogo" alt="Watermark Crest" />
            </div>
            ...
            <div class="certificate-inner">
              ...
              <div class="cert-header">
                <div class="cert-header-left">
                  <div class="serial-tag">
                    <strong>Serial No.:</strong> <span id="d_serialNo">{{ $data['serialNo'] }}</span>
                  </div>
                </div>
                <div class="cert-header-center">
                  <div class="logo-badge-container">
                    <img id="d_logo" class="cert-logo-img" src="{{ $data['instituteLogo'] }}"
                      alt="Emblem" />
                  </div>
                </div>
              ...
              <div class="cert-org-block">
                <h1 class="org-title-main" id="d_orgTitle">{{ $data['councilName'] }}</h1>

                <div class="org-meta-columns">
                  <div class="org-meta-col left">
                    <p class="meta-item"><span class="meta-bullet">▶</span> <span
                        id="d_metaRunBy">{{ $data['metaRunBy'] }}</span></p>
                    <p class="meta-item"><span class="meta-bullet">▶</span> <span
                        id="d_metaRegd">{{ $data['metaRegd'] }}</span></p>
                  </div>
                  <div class="org-meta-col right">
                    <p class="meta-item"><span class="meta-bullet">•</span> <span
                        id="d_metaAutonomous">{{ $data['metaAutonomous'] }}</span></p>
                    <p class="meta-item"><span class="meta-bullet">•</span> <span
                        id="d_metaIso">{{ $data['metaIso'] }}</span></p>
                  </div>
                </div>
              </div>
              ...
              <div class="diploma-banner-row">
                ...
                <div class="student-photo-frame">
                  <img id="d_studentPhoto" src="{{ $data['studentPhoto'] }}" alt="Student Photo" />
                  <span class="photo-alt-label" id="d_photoPlaceholder"
                    style="{{ $data['studentPhoto'] ? 'display:none;' : '' }}">PHOTO</span>
                </div>
              </div>
              ...
              <div class="cert-body">
                ...
                <p class="cert-line certify-text">
                  <em>This is to certify that <span id="d_gender">{{ $data['gender'] }}</span></em>
                </p>
                ...
                <p class="cert-line enroll-text">
                  <em>Enrollment No. : </em> <strong id="d_enrollNo">{{ $data['enrollNo'] }}</strong>
                </p>

                <!-- 6. Institute & Location -->
                <p class="cert-line institute-text">
                  From <span id="d_instituteName">{{ $data['instituteName'] }}</span> , <span
                    id="d_location">{{ $data['location'] }}</span>
                </p>
                ...
                <p class="cert-line division-text">
                  <em>with <span id="d_division">{!! \App\Http\Controllers\DiplomaController::formatDivision($data['division']) !!}</span></em>
                </p>
              ...
              <div class="cert-footer">
                ...
                <div class="footer-col footer-left">
                  <span class="place-text" id="d_place">{{ $data['place'] }}</span>
                </div>

                <div class="footer-col footer-scanner">
                  <div class="scanner-wrap">
                    <img id="d_scannerImage" class="footer-scanner-img" src="{{ $data['scannerImage'] }}"
                      alt="Scanner / QR Code" />
                  </div>
                </div>
                ...
                <div class="footer-col footer-center">
                  <div class="footer-seal-wrapper">
                    <img class="footer-seal-img" id="d_footerSeal" src="{{ $data['footerSeal'] }}"
                      alt="Seal" />
                  </div>
                  <p class="issue-date-text">
                    This <strong id="d_day">{{ $dateParts['day'] }}</strong> day of <strong
                      id="d_monthYear">{{ $dateParts['monthYear'] }}</strong>
                  </p>
                </div>
  ...
  <script>
    window.diplomaPrintUrl = "{{ route('diploma.print') }}";
    window.diplomaIndexUrl = "{{ route('diploma.index') }}";
    window.diplomaSaveUrl  = "{{ route('diploma.save') }}";
  ...
  <script src="{{ asset('diploma-studio/script.js') }}?v={{ time() }}"></script>
</body>
</html>
