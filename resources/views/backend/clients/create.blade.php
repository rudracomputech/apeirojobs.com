...
<div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-8">
    <div class="mx-auto">
        <div class="mb-6">
            ...
            <h2 class="text-2xl font-semibold text-slate-900 dark:text-slate-50">Add New Client</h2>
            <p class="text-sm text-slate-600 dark:text-slate-400">Create a new client record with details and information.</p>
        </div>
        ...
        <form action="{{ route('clients.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="date" id="date" name="date" value="{{ old('date', date('Y-m-d')) }}" class="w-full px-3 py-2.5 text-sm text-slate-900 rounded-md bg-white outline-1 -outline-offset-1 outline-slate-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 dark:text-slate-50 dark:bg-neutral-700 dark:outline-neutral-600">
                    @error('date')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="contact_number" name="contact_number" value="{{ old('contact_number') }}" class="w-full px-3 py-2.5 text-sm text-slate-900 rounded-md bg-white outline-1 -outline-offset-1 outline-slate-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 dark:text-slate-50 dark:bg-neutral-700 dark:outline-neutral-600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="mobile_no" name="mobile_no" value="{{ old('mobile_no') }}" class="w-full px-3 py-2.5 text-sm text-slate-900 rounded-md bg-white outline-1 -outline-offset-1 outline-slate-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 dark:text-slate-50 dark:bg-neutral-700 dark:outline-neutral-600">
                    @error('mobile_no')
                        <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="email" id="email_id" name="email_id" value="{{ old('email_id') }}" class="w-full px-3 py-2.5 text-sm text-slate-900 rounded-md bg-white outline-1 -outline-offset-1 outline-slate-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 dark:text-slate-50 dark:bg-neutral-700 dark:outline-neutral-600">
                    @error('email_id')
                        <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="text" id="area" name="area" value="{{ old('area') }}" class="w-full px-3 py-2.5 text-sm text-slate-900 rounded-md bg-white outline-1 -outline-offset-1 outline-slate-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 dark:text-slate-50 dark:bg-neutral-700 dark:outline-neutral-600">
                    @error('area')
                        <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="city" name="city" value="{{ old('city') }}" class="w-full px-3 py-2.5 text-sm text-slate-900 rounded-md bg-white outline-1 -outline-offset-1 outline-slate-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 dark:text-slate-50 dark:bg-neutral-700 dark:outline-neutral-600">
                    @error('city')
                        <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="state" name="state" value="{{ old('state') }}" class="w-full px-3 py-2.5 text-sm text-slate-900 rounded-md bg-white outline-1 -outline-offset-1 outline-slate-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 dark:text-slate-50 dark:bg-neutral-700 dark:outline-neutral-600">
                    @error('state')
                        <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <textarea id="client_details" name="client_details" rows="4" class="w-full px-3 py-2.5 text-sm text-slate-900 rounded-md bg-white outline-1 -outline-offset-1 outline-slate-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 dark:text-slate-50 dark:bg-neutral-700 dark:outline-neutral-600">{{ old('client_details') }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="feedback" name="feedback" rows="4" class="w-full px-3 py-2.5 text-sm text-slate-900 rounded-md bg-white outline-1 -outline-offset-1 outline-slate-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 dark:text-slate-50 dark:bg-neutral-700 dark:outline-neutral-600">{{ old('feedback') }}</textarea>
                    @error('feedback')
                        <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="text" id="calling_status" name="calling_status" value="{{ old('calling_status') }}" placeholder="e.g., Contacted, Pending" class="w-full px-3 py-2.5 text-sm text-slate-900 rounded-md bg-white outline-1 -outline-offset-1 outline-slate-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 dark:text-slate-50 dark:bg-neutral-700 dark:outline-neutral-600">
                ...
                <div>
                    ...
                    <input type="text" id="vacancy_status" name="vacancy_status" value="{{ old('vacancy_status') }}" placeholder="e.g., Open, Closed" class="w-full px-3 py-2.5 text-sm text-slate-900 rounded-md bg-white outline-1 -outline-offset-1 outline-slate-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 dark:text-slate-50 dark:bg-neutral-700 dark:outline-neutral-600">
                ...
                <div>
                    ...
                    <input type="text" id="requirement_status" name="requirement_status" value="{{ old('requirement_status') }}" placeholder="e.g., Active, Inactive" class="w-full px-3 py-2.5 text-sm text-slate-900 rounded-md bg-white outline-1 -outline-offset-1 outline-slate-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 dark:text-slate-50 dark:bg-neutral-700 dark:outline-neutral-600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="text" id="proposal_status" name="proposal_status" value="{{ old('proposal_status') }}" placeholder="e.g., Sent, Accepted" class="w-full px-3 py-2.5 text-sm text-slate-900 rounded-md bg-white outline-1 -outline-offset-1 outline-slate-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 dark:text-slate-50 dark:bg-neutral-700 dark:outline-neutral-600">
                ...
                <div>
                    ...
                    <input type="text" id="empannel" name="empannel" value="{{ old('empannel') }}" placeholder="e.g., Yes, No" class="w-full px-3 py-2.5 text-sm text-slate-900 rounded-md bg-white outline-1 -outline-offset-1 outline-slate-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 dark:text-slate-50 dark:bg-neutral-700 dark:outline-neutral-600">
                    @error('empannel')
                        <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="internship_payment" name="internship_payment" value="{{ old('internship_payment') }}" placeholder="e.g., Paid, Unpaid" class="w-full px-3 py-2.5 text-sm text-slate-900 rounded-md bg-white outline-1 -outline-offset-1 outline-slate-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 dark:text-slate-50 dark:bg-neutral-700 dark:outline-neutral-600">
            ...
            <div>
                ...
                <textarea id="final_remark" name="final_remark" rows="4" class="w-full px-3 py-2.5 text-sm text-slate-900 rounded-md bg-white outline-1 -outline-offset-1 outline-slate-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 dark:text-slate-50 dark:bg-neutral-700 dark:outline-neutral-600">{{ old('final_remark') }}</textarea>
                @error('final_remark')
                    <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
